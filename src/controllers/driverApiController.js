...
//         return httpResponse(req, res, 404, responseMessage.NO_CABS_FOUND, null, null);
//       }

//       const cabIds = driverCabs.map(cab => cab._id);

//       // Fetch Assigning and Confirmed bookings
...
//         data: { assigning: assigningBookings, confirmed: confirmedBookings },
//       }, null);
...
//       const completedBookings = await Order.find({
//         bookedCab: { $in: cabIds },
...
//     } catch (error) {
//       logger.error(responseMessage.COMPLETED_BOOKINGS_FETCH_FAIL, { meta: { error } });
//       return httpError(next, error, req, 500);
//     }
//   };
